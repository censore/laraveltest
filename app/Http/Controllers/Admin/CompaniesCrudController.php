...
use App\Http\Requests\CompaniesRequest as StoreRequest;
use App\Http\Requests\CompaniesRequest as UpdateRequest;
...
class CompaniesCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setEntityNameStrings('companies', 'companies');
